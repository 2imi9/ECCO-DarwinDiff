...
|---|---|---|---|---|
| 1 | **GEOTRACES IDP2025** — iron + co-measured nutrients/DIC/ALK, depth-resolved bottle and gridded products | <https://www.geotraces.org/idp2025/> | **alpfe** (stuck at 0.80–0.94 off Carroll across 22 experiments; raw_fet w=0.01 moved it to 0.392 but broke scav_rat — classic identifiability degeneracy needs an absolute-units iron observation to fix) | **Step 1 (PR #38)** |
