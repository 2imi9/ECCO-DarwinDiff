...
%
% ROLE IS CARRIED BY STROKE DARKNESS AND LINE WEIGHT, not by hue -- there is no hue here.
% The four role colours collapse onto one luminance ladder, and the ladder is what the
% reader actually resolves. Rendered stroke values, after the !black mixes below:
%   mygreen!50!black  -> black!61   real, measured, not ours   (forcing in, observations out)
%   myblue!50!black   -> black!74   the model                  (network, parameter field, box)
%   myorange!65!black -> black!82   a CHOICE we made           (the collapse)
%   myred             -> black!100  the gradient, and nothing else
% Fills stay faint tints (black!3 to black!9) exactly as in the colour version, so they read
% as grouping, never as category. Do not add a fifth level: 74 and 82 are already the tightest
% adjacent pair, and they are separated by line width (0.7pt vs 1.0pt) as much as by value.
%
...
\colorlet{myblue}{black!48}
\colorlet{mygreen}{black!22}
\colorlet{myorange}{black!72}
