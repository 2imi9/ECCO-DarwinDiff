...
| **T7** global LLC270 seasonal ×1 | global per-fit ask | 546,695 | 2000 | 1 | **362.51** (grid UB 628) | 24.17–72.50 | 70 min | **B200 ×1 (ckpt)** | 1 fit (363 GiB) | 72.5 GiB@5× fits 1 B200 | 2.34 | ❌ (sharding; B200 ~Jul-26) |
...
| **T11 PORT** global seasonal ×1 **EST** | global port seasonal (×1.2) | 546,695 | 2000 | 1 | **435.02** (hi 507) | 29.00–87.00 | 70 min (hi 140) | **B200 ×1 (ckpt)** | 1 fit (435 GiB) | 87 GiB@5× fits 1 B200 | 2.34 | ❌ *(port + sharding + B200 ~Jul-26)* |
...
| **T8** global LLC270 seasonal ×10 (sweep) | 10-seed ens | 546,695 | 2000 | 10 | **3625.14** | 241.7–725.0 *(even 15× = 242 > 192)* | 70 min/fit | per-seed **B200 ×1 (ckpt)** in waves | 10 b1 (NOT one 3625-GiB graph) | 10× ckpt-B200, 10 concurrent → 1.17 h | 23.4 | ❌ (per-seed each oversized; B200 ~Jul-26) |
