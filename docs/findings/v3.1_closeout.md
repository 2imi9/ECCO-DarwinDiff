...
1. 837 seeds across 84 single-lever configs with 0 at 6/6 and 2 single-seed 5/6 events.
2. The 5/6 events are unreproduced at extended seeds (w2e: 1/20; c_chl40: not yet retested but Wave 6 destroys the recipe).
3. **The composition test of the two complementary 5/6 recipes fails to even reach 5/6.**

Across **847 total seeds in 85 configs**, the v3.1 sweep set has 0 seeds at 6/6 and 2 single-seed 5/6 events. The structural ceiling is the headline finding.

## Open questions

1. **Does `c_chl40_posi15` reproduce at n=20?** The first 5/6 path was tested and did not reproduce. The second has not been retested. Marginal value given Wave 6's verdict that the underlying lever stack is fragile in combination. Cost: 1 config × seeds 10-19, ~7 min.
