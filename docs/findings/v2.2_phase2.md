...
**v2.2 ships when** all 6 params land in Calibration-grade or better on a single notebook run. Current best is nb23 at 3/6. v2.2.1 failed; v2.2.2 (loss weighting) is the next experiment.
