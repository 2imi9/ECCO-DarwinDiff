...
| **R_PICPOC** | **50/50** per-AOI (n=50) w/ real Daniels anchor | point-identified given a real calcite anchor; anchor-off → 4/50 (non-circular) | verified-tight | **DONE** | SO Daniels coverage gap noted; not a blocker |
