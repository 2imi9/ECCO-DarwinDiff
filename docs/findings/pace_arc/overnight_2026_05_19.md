...
- `docs/findings/pace_arc/phase1_data_scouting.md` (revised against ground-truth PDF)
- `docs/findings/pace_arc/phase2a_modis_pic_integration.md` (the MODIS integration analysis)
