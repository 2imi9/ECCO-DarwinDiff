...
- **The best operating point `geo1` (`GEOTRACES_W=1`) holds {`alpfe`, `scav_rat`, `R_PICPOC`} jointly in 8/10 seeds** — a **3/4 frontier**, statistically tied with `base`/`dan2` at n=10 (hold-together sweep, 8 configs × n=10). `docs/research_notes/2026-06-26_holdtogether_sweep_results.md`.
